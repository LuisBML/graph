...
cone.position.set(0,27,0);
scene.add( cone );
cone.castShadow =  true;

//Cuadro de fondo
let plane = new THREE.Mesh(new THREE.PlaneGeometry(400,400), new THREE.MeshPhongMaterial({color: 0xFFFFFF}));
